...
pool.query(
  `CREATE TABLE "inventory" ("id" SERIAL NOT NULL, "itemName" character varying NOT NULL, "count" integer NOT NULL, "price" integer NOT NULL, CONSTRAINT "PK_82aa5da437c5bbfb80703b08309" PRIMARY KEY ("id"))`,
);
pool.query(
